	...
	<form method="post" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<!--</tr>-->
				<tr>
					<td>amount	:</td><td><input type="text" name="amount" value="<?php echo $total; ?>"/></td>
				</tr>
				<!--<tr>-->
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="https://arfeenkhan.com/mainwebsite/ccavResponseHandler.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="https://arfeenkhan.com/mainwebsite/ccavResponseHandler.php"/></td>
			 	</tr>
			 	<tr>
		        ...
		        <tr>
		        	<td>Billing Address	:</td><td><input type="text" name="billing_address" value="<?php echo $_SESSION["address"]; ?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing City	:</td><td><input type="text" name="billing_city" value="<?php echo $_SESSION["city"]; ?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing State	:</td><td><input type="text" name="billing_state" value="<?php echo $_SESSION["state"]; ?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Zip	:</td><td><input type="text" name="billing_zip" value="<?php echo $_SESSION["pin"]; ?>"/></td>
		        </tr>
		        <tr>
